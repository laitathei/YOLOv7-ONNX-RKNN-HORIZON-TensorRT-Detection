...
if __name__ == '__main__':
    ...
    with dai.Device() as device:
        ...
        while True:
            ...
            layers_name = q_nn.get().getAllLayerNames()
            output = np.array(q_nn.get().getFirstLayerFp16()).reshape(1, 18900, len(CLASSES)+5) # in_nn.getFirstLayerFp16() = batch size x 18900 x (number of class)+5
            outputs = [output]
